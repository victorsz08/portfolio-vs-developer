...
export default function About() {
  return (
    <section className="flex justify-center items-center h-screen w-screen animate-fade-right animate-delay-200 max-[864px]:p-8 max-[412px]:p-4">
      <div id="about" className="p-10 rounded-xl bg-gray-900 flex justify-between gap-12 items-start max-[864px]:w-full max-[864px]:text-center max-[864px]:justify-center">
        ...
        />
        <div className="flex flex-col h-full justify-between items-start w-[30rem] max-[864px]:w-[20rem] max-[864px]:gap-10 max-[864px]:items-center">
          ...
          <div className="flex flex-col gap-6 justify-start">
            <span 
                className="text-base font-normal text-gray-500 w-[30rem] max-[864px]:w-[20rem] max-[412px]:text-sm"
            >
          ...
          <div className="flex items-center justify-start gap-4">
            <a
              ...
              target="_blank"
              className="p-5 border-purple-600 border rounded-xl max-[412px]:p-3"
            >
              <IoLogoGithub className="w-8 h-8 cursor-pointer text-purple-600 hover:text-purple-800 duration-200 max-[412px]:w-6 max-[412px]:h-6"/>
            </a>
            <a
              ...
              className="p-5 border-purple-600 border rounded-xl max-[412px]:p-3"
            >
              <IoLogoLinkedin className="w-8 h-8 cursor-pointer text-purple-600 hover:text-purple-800 duration-200 max-[412px]:w-6 max-[412px]:h-6" />
            </a>
            <a
              ...
              className="p-5 border-purple-600 border rounded-xl max-[412px]:p-3"
            >
              <IoMail className="w-8 h-8 cursor-pointer text-purple-600 hover:text-purple-800 duration-200 max-[412px]:w-6 max-[412px]:h-6" />
            </a>
          </div>
        </div>
      </div>
