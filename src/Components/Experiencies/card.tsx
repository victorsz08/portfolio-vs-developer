...
export default function CardExp({ title, subtitle, children, link, age, code } : CardProps){
    ...
    return (
        <div className="bg-gray-900 animate-fade-right animate-delay-[300ms] p-8 rounded-lg flex flex-col gap-8 justify-between w-[40rem] max-[480px]:w-[20rem] ">
            <div className="flex justify-between w-full items-start max-[480px]:flex-col max-[480px]:justify-start">
            ...
            <div className="flex justify-start gap-2 items-center max-[480px]:flex-wrap">
                {children}
                <a href={link} 
                    target="_blank" 
                    className="flex justify-center  max-[480px]:px-3 max-[480px]:text-xs
                ...
                <a href={code} target="_blank" 
                    className="flex justify-center gap-1 max-[480px]:px-3 max-[480px]:text-xs 
