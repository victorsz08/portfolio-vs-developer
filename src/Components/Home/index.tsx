        ...
        <section id="home" className="h-screen flex justify-center w-full">
            <div className="flex w-screen justify-around items-center lg:w-full max-[864px]:px-8 max-[864px]:relative">
                <div className="flex flex-col justify-start items-start gap-8 " >
                    <div className="flex flex-col gap-3 max-[480px]:justify-center max-[480px]:items-center max-[480px]:text-center">
                    <h1 className="font-bold text-7xl text-gray-100 max-[480px]:text-5xl">
                        Victor <strong className="font-bold text-purple-600">Siqueira</strong>
                    </h1>
                    <span className="text-lg ml-3 flex items-center text-gray-400 font-normal max-[480px]:text-base">
                            {displayText}
                            <span className={`ml-1 text-purple-600 font-bold ${blink ? 'opacity-100' : 'opacity-0'}`}>|</span>
                        </span>
                    </div>
                    <div className="flex ml-3 justify-start items-center gap-4 max-[480px]:jusify-center max-[480px]:flex-col max-[480px]:justify-center max-[480px]:ml-0 max-[480px]:w-full">
                        <a 
                            href="/curriculo.pdf" 
                        ...
                        <div className="flex items-center justify-center gap-4 max-[480px]:flex max-[480px]:items-center max-[480px]:justify-center">
                ...
                <div>
                    <img className="w-96 max-[864px]:w-86 max-[864px]:absolute max-[480px]:w-60 max-[480px]:translate-x-[-50px]" src="/icon.svg"/>
                </div>
            </div>
        </section>
    )
